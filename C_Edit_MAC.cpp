...
C_Edit_MAC::C_Edit_MAC(){
   for(int n = 0; n < 6; n++){
      ...
      aEdit[n].set_alignment(0.5);
      aBox.pack_start(aEdit[n]);
   }
   
   auto context = aBox.get_style_context();
...
int C_Edit_MAC::setMAC(UCHAR ucV1, UCHAR ucV2, UCHAR ucV3, UCHAR ucV4, UCHAR ucV5, UCHAR ucV6){
   ...
   ostringstream Str_1;
   Str_1 << hex << uppercase << setw(2) << setfill('0') << (int) ucV1;
   aEdit[0].set_text(Str_1.str());

   ostringstream Str_2;
   Str_2 << hex << uppercase << setw(2) << setfill('0') << (int) ucV2; 
   aEdit[1].set_text(Str_2.str());

   ostringstream Str_3;
   Str_3 << hex << uppercase << setw(2) << setfill('0') << (int) ucV3;
   aEdit[2].set_text(Str_3.str());
   
   ostringstream Str_4;
   Str_4 << hex << uppercase << setw(2) << setfill('0') << (int) ucV4;
   aEdit[3].set_text(Str_4.str());
   
   ostringstream Str_5;
   Str_5 << hex << uppercase << setw(2) << setfill('0') << (int) ucV5;
   aEdit[4].set_text(Str_5.str());
   
   ostringstream Str_6;
   Str_6 << hex << uppercase << setw(2) << setfill('0') << (int) ucV6;
